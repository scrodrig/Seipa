...
@NamedQueries({
    ...
    @NamedQuery(name = "DetalleReporte.findById", query = "SELECT d FROM DetalleReporte d WHERE d.id = :id"),
    @NamedQuery(name = "DetalleReporte.findByCampo", query = "SELECT d FROM DetalleReporte d WHERE d.campo = :campo")})
